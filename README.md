...
The device is designed to run on a small LiPo cell or USB power bank. Deep sleep current on the ESP32-C3 is in the range of 5–20 µA, with the MAX4466 adding around 35 µA — giving a very long battery life between trap events.
